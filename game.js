const ports = {
  london: { name: "London", x: 10.8, y: 19.2, owner: "England", market: "Home Office", desc: "Home office, shipyard, and final market.", risk: 1.0, profit: 0 },
  lisbon: { name: "Lisbon", x: 4.8, y: 35.0, owner: "Portugal", market: "European Rival Hub", desc: "A nearby market. Low risk, low reward.", risk: 1.05, profit: 120 },
  cape: { name: "Cape Town", x: 21.5, y: 89.5, owner: "Local Ruler", market: "Cape Resupply", desc: "The long Atlantic route around Africa. Slow but useful.", risk: 1.22, profit: 270 },
  goa: { name: "Goa", x: 59.2, y: 54.3, owner: "Portugal", market: "Pepper and Cotton", desc: "A fortified Portuguese port on India’s western coast.", risk: 1.32, profit: 540 },
  calicut: { name: "Calicut", x: 61.6, y: 60.0, owner: "Local Ruler", market: "Pepper Coast", desc: "The classic pepper run. Good money, good danger.", risk: 1.28, profit: 650 },
  ceylon: { name: "Ceylon", x: 65.2, y: 66.8, owner: "Local Ruler", market: "Cinnamon", desc: "Cinnamon, monsoons, and a useful crossing point.", risk: 1.35, profit: 720 },
  bengal: { name: "Bengal", x: 70.5, y: 50.2, owner: "Local Ruler", market: "Textiles and Opium", desc: "A rich textile region with stronger long-run profits.", risk: 1.4, profit: 860 },
  malacca: { name: "Malacca", x: 78.6, y: 66.4, owner: "Local Ruler", market: "Spice Chokepoint", desc: "A narrow trade gate where fortunes are made.", risk: 1.48, profit: 1010 },
  batavia: { name: "Batavia", x: 81.8, y: 78.5, owner: "Dutch VOC", market: "Nutmeg Monopoly", desc: "Dutch competition is fierce, but spices sell themselves.", risk: 1.6, profit: 1190 },
  canton: { name: "Canton", x: 84.6, y: 47.5, owner: "Qing China", market: "Tea, Silk, Porcelain", desc: "South China coast: tea, silk, porcelain, taxes, and huge profit.", risk: 1.7, profit: 1340 }
};
...
const routes = {
  ...
  bengal: ["london", "lisbon", "cape", "goa", "calicut", "ceylon", "bengal"],
...
// Hand-drawn sea lanes in map-percent coordinates. Ships follow these waypoints,
// so they go around Africa and through the Indian Ocean instead of cutting over land.
const routeWaypoints = {
  lisbon: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0]
  ],
  cape: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5]
  ],
  goa: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.0,58.9],[59.2,54.3]
  ],
  calicut: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0]
  ],
  ceylon: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0],[63.0,63.8],[65.2,66.8]
  ],
  bengal: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0],[63.0,63.8],[65.2,66.8],
    [67.6,61.8],[69.3,55.5],[70.5,50.2]
  ],
  malacca: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0],[63.0,63.8],[65.2,66.8],
    [69.6,70.6],[74.2,70.5],[78.6,66.4]
  ],
  batavia: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0],[63.0,63.8],[65.2,66.8],
    [69.6,70.6],[74.2,70.5],[78.6,66.4],[80.2,72.5],[81.8,78.5]
  ],
  canton: [
    [10.8,19.2],[8.4,22.4],[6.3,28.2],[4.8,35.0],[3.4,45.5],[3.1,57.0],[5.2,68.0],[9.6,78.8],[15.2,87.0],[21.5,89.5],
    [30.5,87.2],[39.2,79.5],[47.5,69.2],[54.5,61.8],[59.2,54.3],[60.4,57.2],[61.6,60.0],[63.0,63.8],[65.2,66.8],
    [69.6,70.6],[74.2,70.5],[78.6,66.4],[82.0,60.5],[84.6,47.5]
  ]
};
...
function routeFor(portId, reverse = false) {
  const base = routeWaypoints[portId] || [[ports.london.x, ports.london.y], [ports[portId].x, ports[portId].y]];
  const pts = base.map(([x, y]) => ({ x, y }));
  return reverse ? pts.reverse() : pts;
}

function pathPoints(portId, reverse = false) {
  return routeFor(portId, reverse);
}
...
function recallFleet(id) {
  ...
  fleet.phase = "returning";
  fleet.progress = Math.max(0, 1 - fleet.progress);
  fleet.timer = fleet.progress * fleet.duration;
  fleet.stopAfterReturn = true;
...
function createRouteOverlay() {
  ...
  Object.entries(routeWaypoints).forEach(([portId, points]) => {
    if (portId === "lisbon") return;
...
function renderTokens() {
  ...
  state.fleets.forEach(fleet => {
    ...
    wrap.style.transform = `translate(-50%, -50%) rotate(${fleet.angle}deg)`;
  ...
  rivals.forEach(rival => {
    rival.fleets.forEach(f => {
      ...
      wrap.style.transform = `translate(-50%, -50%) rotate(${f.angle}deg)`;
